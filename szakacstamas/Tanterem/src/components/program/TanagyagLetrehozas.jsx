...
export default function TananyagLetrehozas() {
  ...
  const handleLetrehozas = () => {
    console.log({ cim, leiras, ido, fajlok });
    navigate(`/kurzus/${id}`);
  };
      ...
      <div className={`w-full max-w-2xl rounded-2xl border backdrop-blur-xl shadow-2xl
        ...
        <div className="p-6 sm:p-8">
          ...
          <h1 className={`text-2xl font-bold text-center mb-1
            ${dark
              ? "bg-gradient-to-r from-cyan-400 via-cyan-400 to-purple-400 bg-clip-text text-transparent"
          ...
          {/* Cím */}
          <div className="mb-5">
            <label className={labelClass}>Tananyag címe</label>
            <input
              type="text"
              value={cim}
          ...
          {/* Leírás */}
          <div className="mb-5">
            <label className={labelClass}>Leírás / Tartalom</label>
            <textarea
              rows={6}
              value={leiras}
              onChange={(e) => setLeiras(e.target.value)}
              placeholder="A tananyag részletes leírása, tartalma..."
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`flex-1 py-2.5 rounded-xl text-sm font-mono border
                ...
                ${dark
                  ? "border-purple-500/40 text-purple-400 hover:bg-purple-500/10 hover:border-purple-400 hover:shadow-[0_0_20px_rgba(160,20,238,0.3)]"
