...
<div className="pointer-events-none fixed inset-0 z-0">
  {dark ? (
    ...
    <>
      <div className="absolute w-[600px] h-[600px] bg-indigo-300/30 blur-[140px] rounded-full top-[-200px] left-[-200px]" />
      <div className="absolute w-[500px] h-[500px] bg-cyan-300/30 blur-[140px] rounded-full bottom-[-160px] right-[-160px]" />
      <div className="absolute w-[500px] h-[500px] bg-violet-300/25 blur-[160px] rounded-full top-[40%] left-[30%]" />
      <div className="absolute w-[400px] h-[400px] bg-pink-300/20 blur-[140px] rounded-full bottom-[30%] right-[20%]" />
...
style={{ marginLeft: mobile ? (sidebarOpen ? "60px" : "0px") : (sidebarOpen ? "220px" : "74px") }}
